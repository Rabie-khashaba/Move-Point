...
<div class="nxl-content">
    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('messagesWorking.index') }}">الرسائل</a></li>
                <li class="breadcrumb-item">تعديل</li>
            </ul>
        </div>
        <div class="page-header-right ms-auto">
            <div class="page-header-right-items">
                <a href="{{ route('messagesWorking.index') }}" class="btn btn-light-brand">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('messagesWorking.update', $message->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="company_id" id="company_id" class="form-control @error('company_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($companies as $company)
                                            <option value="{{ $company->id }}" {{ old('company_id', $message->company_id) == $company->id ? 'selected' : '' }}>{{ $company->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="description" class="form-control" rows="4" placeholder="أدخل الوصف">{{ old('description', $message->description) }}</textarea>
                                    @error('description')
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="url" name="google_map_url" class="form-control @error('google_map_url') is-invalid @enderror"
                                           placeholder="أدخل رابط الخريطة" value="{{ old('google_map_url', $message->google_map_url) }}">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('messagesWorking.index') }}" class="btn btn-light">إلغاء</a>
