        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('lead-targets.store') }}">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>عدد العملاء المحتملين المطلوب <span class="text-danger">*</span></label>
                                    <input type="number" name="leads_count"
                                           class="form-control @error('leads_count') is-invalid @enderror"
                                           value="{{ old('leads_count') }}"
                                           step="1" min="0" placeholder="عدد العملاء المحتملين" required>
                                    @error('leads_count')
