            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('representatives-not-completed.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @if($lead)
...
{{--                                </div>--}}
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('representatives-not-completed.index') }}" class="btn btn-light">إلغاء</a>
