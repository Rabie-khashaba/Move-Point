...
<body>
    <div class="success-container">
        ...
        <div class="next-steps">
            ...
            <ul>
                ...
                <li>سنقوم بالتواصل معك عبر الهاتف لتحديد موعد المقابلة</li>
                <li>ستتم المقابلة في مقر الشركة</li>
                <li>سيتم إخبارك بالنتيجة خلال أسبوع من المقابلة</li>
            </ul>
        </div>
        ...
        <div class="action-buttons">
            <a href="{{ route('landing-page.show') }}" class="btn btn-outline">
                <i class="fas fa-arrow-right me-2"></i>
                العودة لصفحة التقديم
            </a>
            <a href="https://wa.me/201234567890?text=مرحباً، أريد معلومات إضافية عن العمل كمندوب" 
    ...
    <script>
        ...
        setTimeout(function() {
            window.location.href = '{{ route("landing-page.show") }}';
        }, 30000);
