...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('representatives/search', [SupervisorController::class, 'searchRepresentatives'])
        ->name('supervisors.search-representatives');
    ...
    //whats app
    Route::get('/employees/whatsapp/send', [WhatsAppController::class, 'sendTest'])->name('employees.whatsapp.send');
